...
Scenario: A user becomes sick and sets a week as sick
	...
	Then the employee with the ID "CORO" has the personal activity with the name "sick"
...
#	Given an employee with the ID "CORO" exists
#	And the employee registers as sick during week 6
#	And the employee registers as sick during week 11
#	And the employee registers 16 sick workhours during week 6
#	And the employee registers 8 sick workhours during week 11
#	When the employee asks to see sickness between week 5 and week 12
#	Then the employee has been sick in week 6
#	And the employee has been sick in week 11
#	And the employee has has 24 sick hours in the period